...
public class LiteralStringValueExprMetaModel extends LiteralExprMetaModel {
    ...
    LiteralStringValueExprMetaModel(BaseNodeMetaModel superBaseNodeMetaModel) {
    ...
    protected LiteralStringValueExprMetaModel(BaseNodeMetaModel superNodeMetaModel, Class<? extends Node> type, String name, String packageName, boolean isAbstract, boolean hasWildcard) {
