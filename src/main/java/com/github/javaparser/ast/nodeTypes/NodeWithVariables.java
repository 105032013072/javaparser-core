...
public interface NodeWithVariables<N extends Node> {
    ...
    public abstract VariableDeclarator getVariable(int i);

    @SuppressWarnings("unchecked")
    public abstract N setVariable(int i, VariableDeclarator variableDeclarator);

    @SuppressWarnings("unchecked")
    public abstract N addVariable(VariableDeclarator variableDeclarator);
     ...
     */
    public abstract Type getCommonType();
     ...
     */
    @DerivedProperty
    public abstract Type getMaximumCommonType();
